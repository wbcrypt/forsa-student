    ...
    <div className="space-y-5">
      ...
      {isLoading ? <Spinner className="h-40" /> : notifications.length === 0 ? (
        <EmptyState
          ...
          description={locale === 'ar' ? 'أنت في صدارة الأمور! ستظهر هنا تحديثات الطلب وتذكيرات الدفع.' : locale === 'fr' ? 'Vous êtes à jour ! Les mises à jour de dossier et rappels de paiement apparaîtront ici.' : 'You are all caught up! Application updates and payment reminders will appear here.'}
        />
      ) : (
