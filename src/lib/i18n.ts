...
const translations: Record<Locale, Record<string, string>> = {
 ...
 errorTitle: 'Something went wrong',
  ...
  fr: {
    ...
    confirmPassword: 'Confirmer le mot de passe', agreeTerms: "J'accepte les Conditions d'utilisation et la Politique de confidentialité","    applyTitle: 'Demander un financement', applySubtitle: 'Complétez votre dossier en quelques étapes',
